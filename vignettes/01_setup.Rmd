...
MODIS LAI/FPAR data ([MCD15A2H Collection 6.1](https://lpdaac.usgs.gov/products/mcd15a2hv006/)) is downloaded by an included script, relying on the `MODISTools` package. Additional data processing steps to match the temporal resolution and coverage of the flux data include:
